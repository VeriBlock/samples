...
from nodecore_api import NodeCoreApi
import json
...
# Create api object
api = NodeCoreApi(host, rpc_password, True)
...
info = api.getinfo()
print(pretty(info))
print(info['result']['defaultAddress']['address'] + " Balance: " + str(convert_atomic(info['result']['defaultAddress']['unlockedAmount'])) + " VBK")
